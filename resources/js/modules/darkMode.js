export default class DarkMode {
    constructor(config) {
        ...
        this.localStorageKey =
            config?.localStorageKey || "warehouse-dark-mode";
        ...
        // Configuration
        this.uiFeedback = config?.uiFeedback === false ? false : true;
        this.uiButtonActions = config?.uiButtonActions === false ? false : true;
        this.uiOnLoad = config?.uiOnLoad === false ? false : true;
