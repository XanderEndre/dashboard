<!-- Modals: With Form -->
<div x-data="{ isCustomerModalOpen: false }" class="whitespace-normal text-left">

    <!-- Placeholder -->
    <div>
        <!-- Modal Toggle Button -->
        <x-buttons.danger-button x-on:click="isCustomerModalOpen = true; document.body.classList.add('overflow-hidden')" type="button">
    ...
    <!-- END Placeholder -->
    <form method="post" action="{{ route('warehouse.tenants.customer.delete', $customer->id) }}">
        @csrf
        @method('delete')
        <!-- Modal Backdrop -->
        <div x-cloak x-show="isCustomerModalOpen" x-transition:enter="transition ease-out duration-200"
            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
            x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0" x-bind:aria-hidden="!isCustomerModalOpen" tabindex="-1" role="dialog"
            ...
            <div x-cloak x-show="isCustomerModalOpen" x-transition:enter="transition ease-out duration-200"
                ...
                <div class="flex justify-between items-center py-4 px-5 bg-flash-white dark:bg-gray-700/50">
                    <div>
                        ...
                        <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">
                            Remove this customer from the warehouse
                        </h4>
                    </div>
                    <div class="-my-4">
                        <x-buttons.primary-button
                            x-on:click="isCustomerModalOpen = false; document.body.classList.remove('overflow-hidden')" type="button">
                ...
                <div class="p-5 grow">
                    <p>
                        This will remove any connections associated to this customer.
                    </p>
                </div>
                <!-- Footer -->
